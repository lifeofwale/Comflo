<template>
    <main class="col-sm-11 ml-sm-auto col-md-11 col-lg-10 dashboard-content" role="main">
        ...
        <!-- <p class="pull-right mt-lg-5">
            <router-link to="/user/sell-deal" class='btn btn-round venice-bg'>
                New Transaction
            </router-link>
        </p> -->
                ...
                <tbody>
                    <tr v-for="(deal, index) in deals" :key="index">
                      <td class="hidden-md-down"></td>
                          ...
                          <td>
                              <router-link :to="{ name: 'Admin-Contract', params: { id: encodeIt(deal.blockchain, deal.reference, deal.type) }}">
                                  View
                              </router-link>
                          </td>
                    </tr>
