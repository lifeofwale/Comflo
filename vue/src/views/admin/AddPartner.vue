<template>
  <main class="col-sm-11 ml-sm-auto col-md-10 dashboard-content mt-lg-5" role="main">
    <form class="">
        <div class="width-100">
            <h1 class="pull-left">Add Partner</h1>
        </div>
        ...
        <div class="col-md-12 col-lg-12">
            <p class="pull-right mt-10">
                <button type="button" @click="postPartner" :disabled="!emptyText || disable" class="btn btn-round venice-bg">
                    Submit
                </button>
            </p>
            <p class="pull-left mt-10">
                <router-link :to="{ name: 'Admin-Partners'}">
