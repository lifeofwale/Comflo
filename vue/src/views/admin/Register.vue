      ...
      <div class="row mt-lg-5">
        <div class="col-md-12 mt-lg-5">
          <div class="container signup-panel p-lg-3">
            <p class="demo-form-title text-gray text-center"><strong>Sign up for Comflo Admin</strong></p>
            <form class="">
              ...
              <button type="button" @click="postAdmin" :disabled="!emptyText || disable" class="btn btn-primary width-100 mb-lg-3">Submit</button>
              <div class="col-md-12 text-center">
                <router-link :to="{ name: 'Admin-Login'}" class=' text-info'>
                  <a class="login-font">
...
export default {
  ...
  computed: {
    ...
    emptyText () {
      return this.email.length > 0 && this.fname.length > 0 && this.lname.length > 0 && this.phone.length > 0 && this.password.length > 0 && this.password2.length > 0 && this.country.label.length > 0
    }
  },
  methods: {
    ...
    async postAdmin () {
      ...
      let response = await api.adminregister(admin)
      ...
      if (response.data.status === 'success') {
        ...
        this.mainerror = 'An error occured creating a user, please try again or contact support'
        this.resetDetails()
        return false
      }
    }
