...
export default {
  ...
  computed: {
    emptyText () {
      return this.email.length > 0 && this.fname.length > 0 && this.lname.length > 0 && this.phone.length > 0 && this.password.length > 0 && this.company.length > 0 && this.password2.length > 0 && this.country.label.length > 0
    }
  },
  methods: {
    resetDetails () {
