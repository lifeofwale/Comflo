      ...
      <div class="row mt-lg-5">
        <div class="col-md-12 mt-lg-5">
          <div class="container signup-panel p-lg-3">
            <p class="demo-form-title text-gray text-center"><strong>Sign into Comflo Company</strong></p>
            <form class="">
              ...
              <button type="button" @click="loginCompany" :disabled="!emptyText || disable" class="btn btn-primary width-100 mb-lg-3">Submit</button>
              <div class="col-md-12 text-center">
                Don’t have a Comflo Account yet?
                <router-link to="/company/signup" class=' text-info'>
                  <a class="login-font">
                    Signup
                  </a>
                </router-link>
...
export default {
  ...
  methods: {
    ...
    async loginCompany () {
      ...
      let response = await api.companylogin(company)
      loader.hide()
