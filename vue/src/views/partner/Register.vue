      ...
      <div class="row mt-lg-5">
        <div class="col-md-12 mt-lg-5">
          <div class="container signup-panel p-lg-3">
            <p class="demo-form-title text-gray text-center"><strong>Sign up for Comflo Partner</strong></p>
            <form class="">
              <p v-if="mainerror.length > 0" class="text-danger text-center">{{mainerror}}</p>
              <loading :active.sync="visible" :can-cancel="true"></loading>
              <div class="form-group">
                <input type="text" class="form-control" v-model="name" placeholder="Partner Name">
              </div>
              <div class="form-group">
              ...
              <button type="button" @click="postPartner" :disabled="!emptyText || disable" class="btn btn-primary width-100 mb-lg-3">Submit</button>
              <div class="col-md-12 text-center">
                <router-link to="/partner/login" class=' text-info'>
                  <a class="login-font">
...
export default {
  ...
  methods: {
    ...
    async postPartner () {
      ...
      let response = await api.partnerregister(partner)
