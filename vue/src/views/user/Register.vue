        ...
        <div class="col-md-12 mt-lg-2">
          <div class="container signup-panel p-lg-3">
            ...
            <form class="">
              ...
              <button type="button" @click="postUser" :disabled="!emptyText || disable" class="btn btn-primary width-100 mb-lg-3">Submit</button>
...
export default {
  ...
  computed: {
    ...
    emptyText () {
      return this.email.length > 0 && this.fname.length > 0 && this.lname.length > 0 && this.phone.length > 0 && this.company.length > 0 && this.password.length > 0 && this.password2.length > 0 && this.country.label.length > 0 && this.isTCChecked === true
    }
  },
  methods: {
