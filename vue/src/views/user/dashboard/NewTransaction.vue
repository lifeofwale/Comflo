        ...
        <form action="" class="request__regform" id="regForm">
          <div class="d-flex justify-content-between">
            ...
            <div class="request__step text-center">
              ...
              <p class="mb-0 clr--grey">Price Information</p>
            ...
            <div class="request__step text-center">
              ...
              <p class="mb-0 clr--grey">Upload Documents</p>
          ...
          <fieldset :class="{ request__commodity: isActive != 0 }" class="mt-5 mb-3">
            <div class="card border-0 p-5">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group mb-5">
                    <label for="inputQuantity">QUANTITY (MT) <sup>*</sup></label>
                    <input autocomplete="off" type="text" @keyup="isNumber($event)" @keypress='isNumber($event)' v-model="quantity" class="form-control cinput" id="inputQuantity"
                     required>
                  </div>
                </div>
                <div class="col">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group mb-5">
                    ...
                    <input type="text" v-model="location" class="form-control cinput" id="inputLocation"
                      required>
                  </div>
                </div>
