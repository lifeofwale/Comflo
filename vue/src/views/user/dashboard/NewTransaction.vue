        ...
        <form action="" class="request__regform" id="regForm">
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control cinput" id="inputCommodity"
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control cinput" id="inputQuantity"
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control cinput" id="inputLocation" placeholder="Enter Location"
                      required>
                  </div>
                </div>
          ...
          <fieldset :class="{ request__commodity: isActive != 2 }" class="mt-5 mb-5">
            <div class="card border-0 p-5">
              ...
              <div class="d-flex">
                <button style="font-size: 16px;" class="btn btn-link bg-transparent">+Add document</button>
              </div>
              <div class="row mt-3">
                <div class="col">
                  <div class="form-group mb-5">
                    <label for="inputmoreinfo">MORE INFORMATION</label>
                    <textarea type="text" class="form-control cinput" id="inputmoreinfo" rows="5" required>
                            </textarea>
                  </div>
                </div>
              </div>
          ...
          <div class="d-flex justify-content-center mb-10">
            ...
            <button @click="isActive++" v-if="isActive < 1" type="button" class="btn  button__primary  mx-2" id="nextBtn">NEXT</button>
            <button @click="isActive++" v-if="isActive === 1" type="button" class="btn  button__primary  mx-2" id="nextBtn">NEXT</button>
            <button @click="saveTransaction" :disabled="!emptyText || disable" v-if="isActive === 2" type="button" class="btn  button__primary  mx-2" id="nextBtn">SUBMIT</button>
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    emptyText () {
      return this.commodity.length > 0 && this.quantity.length > 0 && this.price.length > 0 && this.payment.length > 0 && this.incoterm.value.length > 0 && this.location.length > 0 && this.currency.cc.length > 0
    }
  },
  methods: {
